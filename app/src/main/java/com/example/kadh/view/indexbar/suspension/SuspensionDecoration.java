package com.example.kadh.view.indexbar.suspension;
...
import com.example.kadh.view.indexbar.helper.IIndexBarDataHelper;
import com.example.kadh.view.indexbar.helper.IndexBarDataHelperImpl;
...
public class SuspensionDecoration<T> extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#F7F8FA");
    private static int COLOR_TITLE_FONT = Color.parseColor("#1886e3");
    ...
    public SuspensionDecoration(Context context, List<? extends BaseIndexPinyinBean> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = ScreenUtils.dpToPxInt(20);
        ...
        mTextStartMargin = ScreenUtils.dpToPxInt(20);
    }
    ...
    public SuspensionDecoration setmDatas(List<? extends BaseIndexPinyinBean> mDatas) {
        this.mDatas = mDatas;
        initSourceDatas();
        return this;
    }
    ...
    private void initSourceDatas() {
        ...
        //汉语->拼音
        mDataHelper.convert(mDatas);
        //拼音->tag
        mDataHelper.fillInexTag(mDatas);
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft() + mTextStartMargin, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, child.getPaddingLeft() + mTextStartMargin,
