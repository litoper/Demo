...
public class CircleImageView_github extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircleImageView_github(Context context) {
        super(context);

        init();
    }

    public CircleImageView_github(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImageView_github(Context context, AttributeSet attrs, int defStyle) {
