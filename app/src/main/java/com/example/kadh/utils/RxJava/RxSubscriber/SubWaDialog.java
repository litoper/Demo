...
public class SubWaDialog {
    ...
    public SubWaDialog(Context context, SubProgress subProtect, boolean cancelable, int tag) {
...
//            }
//            if (!mSweetAlertDialog.isShowing() && !((Activity) mContext).isFinishing() && !((Activity) mContext).isDestroyed()) {
//                mSweetAlertDialog.show();
//            }
        }
    }
