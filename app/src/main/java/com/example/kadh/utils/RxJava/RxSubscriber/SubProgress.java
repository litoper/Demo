...
public class SubProgress<T> extends DisposableSubscriber<T> {
    private static final String TAG = "SubProtect";
    private SubNextImpl<T> mSubListener;
    private Context mContext;
    private SubMdDialog mDialog;

    public SubProgress(@NonNull SubNextImpl<T> subListener, Context context, int tag) {
        this.mSubListener = subListener;
        this.mContext = context;
        this.mDialog = new SubMdDialog(context, this, false, tag);
    }
