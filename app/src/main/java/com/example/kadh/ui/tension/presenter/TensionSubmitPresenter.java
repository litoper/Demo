 ...
 * @desc :
 */
public class TensionSubmitPresenter extends BasePresenterImpl<TensionSubmitAtvContract.View> implements TensionSubmitAtvContract.Presenter<TensionSubmitAtvContract.View> {
